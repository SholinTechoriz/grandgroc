...
import com.e.sholinpaul.grandgroc.ui.fragment.AllOrdersFragment;
...
public class AllOrderFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AllOrderFragmentAdapter(ArrayList<OrderModel> newOrderList, Context mcontext, AllOrdersFragment fragment) {
